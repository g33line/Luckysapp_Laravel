			...
			@csrf 
				...
				<div class="card p-3">
					<div class="card-body">
						...
						<div class="row mb-3">
							<img id="showImage" src="{{ (!empty($adminData->profile_photo_path))?url('upload/'.$adminData->profile_photo_path):url('upload/no_image.jpg') }}" style="width:170px; height:150px;">
						</div>
